    ...
    <section className="min-h-screen flex items-center justify-center bg-sky-600 text-white" id="hero">
      <div className="max-w-4xl w-full flex flex-col items-center text-center gap-6 px-4">
        ...
        >
          <a
            href="#projects"
            className="px-6 py-3 rounded-full bg-white text-sky-600 font-semibold shadow-md hover:bg-sky-100 transition-all duration-300 dark:bg-white dark:text-sky-600 dark:hover:bg-sky-100"
          >
            View Projects
          </a>
          <a
            href="#contact"
            className="px-6 py-3 rounded-full border border-white text-white font-medium hover:bg-white/10 transition-all duration-300 dark:border-white dark:text-white"
          >
            Contact Me
          </a>
        </motion.div>
